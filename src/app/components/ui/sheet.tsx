    ...
    <SheetPortal>
      ...
      <SheetPrimitive.Content
        ...
        className={cn(
          ...
          // Right side - full width on mobile, max-w-sm on larger screens
          side === "right" &&
          ...
          // Left side - full width on mobile, max-w-sm on larger screens  
          side === "left" &&
          ...
          side === "bottom" &&
            "data-[state=closed]:slide-out-to-bottom data-[state=open]:slide-in-from-bottom inset-x-0 bottom-0 h-auto max-h-[85vh] border-t overflow-y-auto",
          className,
        )}
        {...props}
      >
